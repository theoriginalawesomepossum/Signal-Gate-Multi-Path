...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateButtonColors() {
        ...
        multiPointHubButton.setBackgroundColor(customColor)
        helpButton.setBackgroundColor(customColor)
        setDefaultButton.setBackgroundColor(customColor)
        requestContactsButton.setBackgroundColor(customColor)
        manageBlockedNumbersButton.setBackgroundColor(customColor)
    }

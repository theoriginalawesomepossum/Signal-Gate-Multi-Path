import { CallScreeningModule as callScreeningModule, IncomingCall } from '../native-modules/call-screening/CallScreeningModule';
...
import { PatternRulesService } from './services/pattern-rules';
import { ManualListService } from './services/manual-list';
import { SmartAllowListService } from './services/smart-allow-list';
import { ContactGroupWhitelistService } from './services/contact-group-whitelist';
 ...
 */
// Singleton instance
let bridgeInstance: CallScreeningBridge | null = null;
